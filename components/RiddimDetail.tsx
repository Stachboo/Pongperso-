                ...
                <tr key={`${v.artist}-${v.title}`} className={styles.tableRow}>
                  ...
                  <td className={styles.actionsCell}>
                    <a
                      ...
                      aria-label={dict.ariaSearchYoutube.replace('{x}', `${v.artist} ${v.title}`)}
                    >
                      <YoutubeIcon />
                    </a>
                    <a
                      ...
                      aria-label={dict.ariaListenSpotify.replace('{x}', `${v.artist} ${v.title}`)}
                    >
                      <SpotifyIcon />
                    </a>
                    <a
                      ...
                      aria-label={dict.ariaSearchDeezer.replace('{x}', `${v.artist} ${v.title}`)}
                    >
                      <DeezerIcon />
                    </a>
                  </td>
